...
export default function HomeServiceScreen() {
    ...
    return (
        <View style={cs.root}>
            <View style={{ height: insets.top, backgroundColor: '#0D1445' }} />
            <LinearGradient
                colors={['#0D1445', '#0D1B4B', '#1A0050']}
                style={cs.header}
            >
                <Text style={cs.headerTitle}>SlotB Home Service</Text>
            </LinearGradient>
            <View style={cs.body}>
                <Text style={cs.emoji}>🔧</Text>
                <Text style={cs.title}>Coming Soon</Text>
                <Text style={cs.sub}>{"Local pros at your doorstep!\nElectricians, plumbers & more — live shortly."}</Text>
                <View style={cs.badge}>
                    <Text style={cs.badgeText}>Electrician · Plumber · RO Service · CCTV</Text>
                </View>
            </View>
        </View>
    );
...
const cs = StyleSheet.create({
    ...
    headerTitle: { fontSize: 20, fontWeight: '900', color: '#A5B4FC', letterSpacing: 0.3 },
    body: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32, gap: 14 },
    emoji: { fontSize: 64, marginBottom: 8 },
    title: { fontSize: 32, fontWeight: '900', color: '#1A0050', letterSpacing: 0.5 },
    ...
    badgeText: { fontSize: 12, fontWeight: '700', color: '#4C1D95' },
});

// ─────────────────────────────────────────────────────────────────────────────
// ORIGINAL HOME SERVICE SCREEN CODE — preserved below, commented out (Coming Soon)
// ─────────────────────────────────────────────────────────────────────────────

// import React, { useRef } from 'react';
// import { View, Text, StyleSheet, Pressable, Dimensions, Animated } from 'react-native';
// import { Zap, Wrench, Droplets, Camera } from 'lucide-react-native';
...
//     { label: 'RO Service', Icon: Droplets },
...
//             <SectionHeader title="Home Service" scrollY={scrollY} searchPlaceholder="Search services..." accentColor="#7C3AFF" gradientColors={['#0D1445', '#0D1B4B', '#1A0050']} />
